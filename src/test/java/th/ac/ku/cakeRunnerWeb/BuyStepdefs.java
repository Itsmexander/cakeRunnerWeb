...
//    @Given("a product {string} with weight {int}, price {int}, and stock of {int} exists")
//    public void a_product_exists(String name, int weight, int price , int amount) {
//        catalog.addProduct1(name, weight, price,amount);
//    }
