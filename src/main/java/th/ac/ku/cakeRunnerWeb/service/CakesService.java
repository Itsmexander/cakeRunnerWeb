...
public class CakesService {
    ...
    private Map<String, Cakes> products;
...
//    public void addProduct(UUID id, String name, int weight, int price , int amount){
//        products.put(name , new Cakes(id, name, weight, price, amount));
//    }
//
//    public void addProduct1(String name, int weight , int price , int amount){
//        products.put(name , new Cakes(name,weight,price,amount));
//    }

    public Cakes getProduct(String name) {return products.get(name); }
